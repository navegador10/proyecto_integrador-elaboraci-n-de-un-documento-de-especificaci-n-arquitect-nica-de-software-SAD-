...
El sistema se plantea para una red hospitalaria multisede, contemplando la gestión de pacientes, historias clínicas, citas médicas, telemedicina, integración con laboratorios y mecanismos de seguridad y confidencialidad.
...
Para permitir una evaluación arquitectónica objetiva, se establecen inicialmente los siguientes objetivos:

| Atributo | Objetivo |
|---|---|
| Disponibilidad | ≥ 99,5 % mensual |
| Rendimiento | ≤ 2 segundos para consultas habituales |
| Escalabilidad | Capacidad de agregar recursos conforme aumente la demanda |
| Seguridad | 100 % de las comunicaciones protegidas mediante mecanismos seguros |
| Auditabilidad | 100 % de operaciones críticas registradas |
| Integridad | 0 pérdida intencional de información clínica durante operaciones normales |
| Recuperación | Contar con procedimientos definidos de respaldo y recuperación |
| Interoperabilidad | Capacidad de integrar servicios externos mediante interfaces estandarizadas |

> **Nota:** Estos valores representan objetivos iniciales de arquitectura y deberán validarse con los stakeholders durante las siguientes etapas del proyecto.
